...
export default function InvestHeroSimple() {
    return (
        <section className="relative isolate flex min-h-[100svh] w-full flex-col items-center justify-end overflow-hidden">
            <div className="z-20 flex w-full max-w-4xl flex-col items-center justify-center gap-8 px-4 py-16 text-center">
                ...
                >
                    Invest in{' '}
                    <span className="font-bold italic">Shared Prosperity</span>
                </m.h1>
                <m.p
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    Join our democratic cooperative movement. From as little as $1 (131 HTG), become a co-owner of transformative drone technology and earn returns while building Haiti's technological future together.
                </m.p>
                <m.div
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    ...
                    >
                        <a href="#investment-plans">Start Investing</a>
                    </Button>
                    <Button 
                        asChild
                        variant="outline"
                    ...
                    >
                        <a href="/impact">View Returns</a>
                    </Button>
                </m.div>
            </div>

            {/* Pattern overlay - Purple theme for investment */}
            <div className="absolute top-1/5 left-1/2 aspect-square w-[200%] -translate-x-1/2 rounded-full bg-purple-950 blur-[200px] md:top-1/3" />
