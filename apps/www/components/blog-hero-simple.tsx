...
export default function BlogHeroSimple() {
    return (
        <section className="relative isolate flex min-h-[100svh] w-full flex-col items-center justify-end overflow-hidden">
            <div className="z-20 flex w-full max-w-4xl flex-col items-center justify-center gap-8 px-4 py-16 text-center">
                ...
                >
                    Knowledge &{' '}
                    <span className="font-bold italic">Community Insights</span>
                </m.h1>
                <m.p
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    Stay informed about drone technology developments, cooperative progress, and educational content designed to empower our community with knowledge about Haiti's technological transformation.
                </m.p>
                <m.div
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    ...
                    >
                        <a href="#featured">Explore Content</a>
                    </Button>
                    <Button 
                        asChild
                        variant="outline"
            ...
            {/* Pattern overlay - Updated colors for blog theme */}
            <div className="absolute top-1/5 left-1/2 aspect-square w-[200%] -translate-x-1/2 rounded-full bg-teal-950 blur-[200px] md:top-1/3" />
