    ...
    return (
        <section className="relative isolate flex min-h-[100svh] w-full flex-col items-center justify-end overflow-hidden">
            <div className="z-20 flex w-full max-w-4xl flex-col items-center justify-center gap-8 px-4 py-16 text-center">
                ...
                >
                    Building Haiti's{' '}
                    <span className="font-bold italic">Technological Future</span>
                </m.h1>
                <m.p
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    ...
                    >
                        <a href="/invest">Join Our Movement</a>
                    </Button>
                    <Button 
                        asChild
                        variant="outline"
            ...
            {/* Pattern overlay - Green theme for about */}
            <div className="absolute top-1/5 left-1/2 aspect-square w-[200%] -translate-x-1/2 rounded-full bg-green-950 blur-[200px] md:top-1/3" />
