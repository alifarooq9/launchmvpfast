...
export default function ImpactHeroSimple() {
    return (
        <section className="relative isolate flex min-h-[100svh] w-full flex-col items-center justify-end overflow-hidden">
            <div className="z-20 flex w-full max-w-4xl flex-col items-center justify-center gap-8 px-4 py-16 text-center">
                ...
                >
                    Measuring Our{' '}
                    <span className="font-bold italic">Collective Success</span>
                </m.h1>
                <m.p
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    Track the Haiti Drone Cooperative's performance and transformative impact across communities through transparent, blockchain-verified metrics. See exactly how your investment contributes to Haiti's technological advancement and economic development.
                </m.p>
                <m.div
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    ...
                    >
                        <a href="/invest">View Investment Opportunities</a>
                    </Button>
                    <Button 
                        asChild
                        variant="outline"
                    ...
                    >
                        <a href="#financial">Explore Metrics</a>
                    </Button>
                </m.div>
            </div>

            {/* Pattern overlay - Updated colors for impact theme */}
            <div className="absolute top-1/5 left-1/2 aspect-square w-[200%] -translate-x-1/2 rounded-full bg-blue-950 blur-[200px] md:top-1/3" />
