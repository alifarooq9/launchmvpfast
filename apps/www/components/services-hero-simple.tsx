...
export default function ServicesHeroSimple() {
    return (
        <section className="relative isolate flex min-h-[100svh] w-full flex-col items-center justify-end overflow-hidden">
            <div className="z-20 flex w-full max-w-4xl flex-col items-center justify-center gap-8 px-4 py-16 text-center">
                ...
                >
                    Transformative{' '}
                    <span className="font-bold italic">Drone Services</span>
                </m.h1>
                <m.p
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    From agricultural monitoring to emergency response, we provide comprehensive drone services that empower communities, enhance productivity, and drive sustainable development across Haiti.
                </m.p>
                <m.div
                    animate={{
                        transform: 'translateY(0)',
                ...
                >
                    ...
                    >
                        <a href="#services-overview">View All Services</a>
                    </Button>
                </m.div>
            </div>

            {/* Pattern overlay - Orange theme for services */}
